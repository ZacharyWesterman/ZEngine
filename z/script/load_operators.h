...
namespace z
{
    namespace script
    {
        ...
        bool load_oper_lib(core::sorted_ref_array< script::oper::oper_t<char>* >* output,
                           const core::string<char>& file_name)
        {
            typedef void (__stdcall *_func) (core::sorted_ref_array< script::oper::oper_t<char>* >*);
        ...
        bool load_oper_lib(core::sorted_ref_array< script::oper::oper_t<wchar_t>* >* output,
                           const core::string<char>& file_name)
        {
            typedef void (__stdcall *_func) (core::sorted_ref_array< script::oper::oper_t<wchar_t>* >*);
        ...
        void load_operators(core::sorted_ref_array< script::oper::oper_t<char>* >* output,
        ...
        void load_operators(core::sorted_ref_array< script::oper::oper_t<wchar_t>* >* output,
                            const core::string<char>& folder_name)
        {
            core::array< core::string<char> > files;
