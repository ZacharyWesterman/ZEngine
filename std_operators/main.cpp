...
__declspec(dllexport) void __cdecl get_opers_c(z::core::sorted_ref_array< z::script::oper::oper_t<char>* >* output)
{
    if (output)
    {
        //Addition
...
__declspec(dllexport) void __cdecl get_opers_w(z::core::sorted_ref_array< z::script::oper::oper_t<wchar_t>* >* output)
{
    if (output)
    {
        //Addition
